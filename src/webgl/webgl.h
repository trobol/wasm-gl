...
i32 glGetUniformLocation(i32 program, const char name[1], i32 name_len);
void glGetString(void);
void glLinkProgram(i32 program);
void glLogicOp(void);
void glShaderSource(i32 shader, const char source[1], i32 source_len);
...
void glTexSubImage2D(i32 target, i32 level, i32 xoff, i32 yoff, i32 width, i32 height, i32 format, i32 type, u8 data[1], i32 len);
void glUniform1i(i32 location, i32 value);
void glUniform3fv(i32 location, f32 x, f32 y, f32 z);
void glUniformMatrix4fv(i32 location, const f32 data[16]);
